...
<head>
    ...
    {{-- image-style --}}
    <link rel="stylesheet" href="{{ asset('admin/dist/css/image-style.css') }}">
...
<body class="hold-transition sidebar-mini layout-fixed {{ Auth::user()->mode }}-mode">
        ...
        <aside class="main-sidebar sidebar-{{ Auth::user()->mode }}-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="pb-3 mt-3 mb-3 user-panel d-flex">
                    <div class="image">
                        <img src="{{ asset('admin/dist/img/passport_photo.jpg') }}" class="img-circle elevation-2"
    ...
    {{-- jasny-fileupload --}}
    <script src="{{ asset('admin/plugins/jasny-bootstrap/jasny-bootstrap.min.js') }}"></script>
